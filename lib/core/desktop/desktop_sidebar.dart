...
=======
    ...
    SidebarSectionModel(title: 'الحسابات', items: [
      ...
      SidebarItemModel(icon: Iconsax.user_tick, label: 'العملاء', routeType: RouteType.customers),
    ...
    SidebarSectionModel(title: 'النظام', items: [
      ...
      SidebarItemModel(icon: Iconsax.calendar_1, label: 'السنوات المالية', routeType: RouteType.financialYears),
...
=======
              const SidebarHeader(appName: 'Accounting System', subtitle: 'Offline Accounting'),
