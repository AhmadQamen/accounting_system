              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'محاسب بسيط • Offline First',
                      style: TextStyle(color: context.colors.textSecondary),
                    ),
                    const SizedBox(height: 28),
                    const TextField(
                      decoration: InputDecoration(labelText: 'المستخدم'),
                      controller: null,
                    ),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: auth.isLoggingIn
                            ...
                            : const Text('دخول محلي'),
                      ),
                    ),
                    const SizedBox(height: 12),
                    Text(
                      'هذه النسخة تعمل محلياً. اربط Backend المصادقة لاحقاً للمزامنة متعددة الأجهزة.',
