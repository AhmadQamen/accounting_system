...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: compact ? AppBar(title: const Text('الإعدادات')) : null,
      body: PremiumPage(
        maxWidth: 1180,
        child: Column(
                  ...
                  child: PremiumPanel(
                    child: sync.when(
                      ...
                      data: (s) {
                        ...
                        final conflicts = ((s['conflicts'] as num?) ?? 0).toInt();
                        final configured = (s['backend_configured'] as bool?) ?? false;
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('${s['last_sync_at'] ?? 'لم تتم المزامنة بعد'}', style: TextStyle(color: context.colors.textPrimary, fontSize: 11.5, fontWeight: FontWeight.w800)),
                                      ],
                                    ),
                                  ),
                                  FilledButton.icon(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Material(
                      ...
                      borderRadius: BorderRadius.circular(16),
                      child: ListTile(
                        leading: Container(width: 40, height: 40, decoration: BoxDecoration(color: context.colors.error.withValues(alpha: .10), borderRadius: BorderRadius.circular(13)), child: Icon(Icons.delete_outline_rounded, color: context.colors.error, size: 19)),
                        title: Text('حذف قاعدة البيانات المحلية', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.w900)),
                        subtitle: Text('للتطوير فقط. يحذف كل البيانات المحلية من هذا الجهاز.', style: TextStyle(color: context.colors.textDim)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(title, style: TextStyle(color: colors.textPrimary, fontWeight: FontWeight.w900, fontSize: 12.5)), const SizedBox(height: 2), Text(subtitle, style: TextStyle(color: colors.textDim, fontSize: 10.5))])),
          trailing,
        ],
      ),
    );
